...
var towards = Math.random();

function Loader(config, environment, resourceMap) {

  // console.warn(global.__webpack_require__);
...
Loader.prototype._execModule = function(moduleObj) {
  ...
  // console.warn(moduleObj.require);
...
Loader.prototype.resetModuleRegistry = function() {
  ...
  this._builtInModules = {
    'jest-runtime': function(currPath) {
      var jestRuntime = {
        exports: {
          // Expose loader to compiles webpack src to use in __webpack_require__
          // NOTE: this shouldn't be done here, __webpack_require__ should be exposed
          // to this module as at least this file is code. rather than code generating code.
          loader: this,
          moduleMocker: moduleMocker,
          foo: function(arg) {
            console.warn('foo!', arg)
          },
